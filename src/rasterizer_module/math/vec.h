...
#define vec_add(a, b) _Generic((a), vec3f: vec3f_add)(a, b)
#define vec_sub(a, b) _Generic((a), vec3f: vec3f_sub)(a, b)
#define vec_dot(a, b) _Generic((a), vec3f: vec3f_dot)(a, b)
#define vec_scale(a, s) _Generic((a), vec3f: vec3f_scale)(a, s)
#define vec_normalize(a) _Generic((a), vec3f: vec3f_normalize)(a)
#define vec_cross(a, s) _Generic((a), vec3f: vec3f_cross)(a, s)
